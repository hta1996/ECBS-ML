...
int main(int argc, char** argv) 
{
	...
	desc.add_options()
		...
		("ncollect",po::value<int>()->default_value(1), "Num of solutions to collect")
    ...
    int num_of_solution_to_collect=vm["ncollect"].as<int>();
	...
	case 2:  // ECBS
	{
		...
		ecbs.num_of_solution_to_collect=num_of_solution_to_collect;
        ...
        else
        {
			...
			{
				ecbs.feature_weight.push_back(x);
				cerr<<x<<" ";
			}
			cerr<<"\n";
