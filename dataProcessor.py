...
RunEcbs1=".scen -n "
RunEcbs2=" -o TRAIN"+str(N)+"/"+"tmp.csv -t 300 -w 1.1 -s 2 --ncollect 21 --featFile "
...
for N in num_of_agent:
    for scen in range(25):
        weightFile=" --weightFile ../train/TRAIN"+str(N)+"/model10_coef.txt"
...
for _ in range(15): #rounds of iterations
    for scen in range(25):
        for n in range(1):
            ...
            print(RunEcbs)
            if 1 or _>=10 or (_==9 and Scen>=12):
                os.system(RunEcbs)
            datap=[]
